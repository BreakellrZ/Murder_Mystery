...
def common_room():
    decision = input("You made your way back to the Common Room. Would you like to go to the Living room or the Main hall? (Main Hall / Living Room)").lower()
    if decision == "Main Hall":
        main_hall()
...
#             common_room()
#         else: 
#             print("Invalid input - please type in Bedrooms or Common Room to the terminal")
#     elif decision == "bedrooms":
#         bedroom()
#     else:
...
def bedroom():
    ...
    if decision == "bathroom":
        print("Medicine cabnit looks empty, looks nice and clean... uhh jesus there looks like there is some drops of blood in the sink.. this must be where the killer sleeps this must be the killer.. I must ask to see who's room this is! It looks like they were in a rush and did not clean properly")
        notes.append("Drops of Blood in sink - killer in a rush - Who's Bedroom is that?")
